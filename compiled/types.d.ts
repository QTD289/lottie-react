import type { AnimationConfigWithData, AnimationDirection, AnimationEventName, AnimationItem, AnimationSegment, RendererType } from "lottie-web";
import React, { MutableRefObject, AnimationEventHandler, ReactElement, RefObject } from "react";
...
export type LottieOptions<T extends RendererType = "svg" | "canvas"> = Omit<AnimationConfigWithData<T>, "container" | "animationData"> & {
